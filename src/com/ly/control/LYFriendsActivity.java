...
Runnable r3 = new Runnable() {
		...
		public void run() {
			...
			try {
				URL url = new URL("http://"+GLOBAL.IP+":8080/Lvyou/FriendListServlet");
	...
	Handler  h=new  Handler()
	  ...
	  Runnable r4 = new Runnable() {
			...
			public void run() {
				//LoginUserHandler luh = new LoginUserHandler();
				try {
					URL url = new URL("http://"+GLOBAL.IP+":8080/Lvyou/AttentionServlet");
					HttpURLConnection htc = (HttpURLConnection) url.openConnection();
					htc.setDoInput(true);
					htc.setDoOutput(true);
					htc.setRequestMethod("POST");
		...
		Handler  haa=new  Handler()
		  {
			  ...
			  Runnable r1 = new Runnable() {
					...
					public void run() {
						//LoginUserHandler luh = new LoginUserHandler();
						try {
							URL url = new URL("http://"+GLOBAL.IP+":8080/Lvyou/LYApplyServlet");
							HttpURLConnection htc = (HttpURLConnection) url.openConnection();
							htc.setDoInput(true);
							htc.setDoOutput(true);
							htc.setRequestMethod("POST");
				...
				Handler  ha=new  Handler()
				  ...
				  Runnable r2 = new Runnable() {
						...
						public void run() {
							//LoginUserHandler luh = new LoginUserHandler();
							try {
								URL url = new URL("http://"+GLOBAL.IP+":8080/Lvyou/DeleteApplyServlet");
								HttpURLConnection htc = (HttpURLConnection) url.openConnection();
								htc.setDoInput(true);
								htc.setDoOutput(true);
								htc.setRequestMethod("POST");
...
//								//LoginUserHandler luh = new LoginUserHandler();
//								try {
//									URL url = new URL("http://"+GLOBAL.IP+":18080/FX_Donkey/FXAddFriendsServlet");
//									HttpURLConnection htc = (HttpURLConnection) url.openConnection();
//									htc.setDoInput(true);
//									htc.setDoOutput(true);
//									htc.setRequestMethod("POST");
...
//						};
						  ...
						  Runnable r6 = new Runnable() {
								...
								public void run() {
									//LoginUserHandler luh = new LoginUserHandler();
									try {
										URL url = new URL("http://"+GLOBAL.IP+":8080/Lvyou/DeleteFriendsServlet");
										HttpURLConnection htc = (HttpURLConnection) url.openConnection();
										htc.setDoInput(true);
										htc.setDoOutput(true);
										htc.setRequestMethod("POST");
							...
							private void resetms() {
								//LoginUserHandler luh = new LoginUserHandler();
								try {
									URL url = new URL("http://"+GLOBAL.IP+":8080/Lvyou/LYApplyyServlet");
									HttpURLConnection htc = (HttpURLConnection) url.openConnection();
									htc.setDoInput(true);
									htc.setDoOutput(true);
									htc.setRequestMethod("POST");
